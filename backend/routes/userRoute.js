...
router.post('/register', expressAsyncHandler(async (req, res) => {
    ...
    if(user.email == '' || user.password == '' || user.username == ''){
        ...
        if (newUser && save_prep_verify) {
            ...
            const mailOptions = {
                from: 'info@nodemongobackend.com',
                to: newUser.email,
                subject: 'ACTIVATION MESSAGE FORM nodemongobackend',
                text: 'Your sign up was successful, click this link https://www.nodemongobackend.com/' +
        ...
        if(time_check){
            ...
            if(save_prep_verify){
                ...
                const mailOptions = {
                    from: 'info@nodemongobackend.com',
                    to: user.email,
                    subject: 'nodemongobackend - PASSWORD RESET LINK',
                    text: 'Hello, we received your request to reset your password. Click this link https://www.nodemongobackend.com/' +
                            ...
                            'please contact info@nodemongobackend.com. Thanks!'
                };
...
router.get("/createadmin", async (req, res) => {
    let _password = "admin_08";
    try {
        const user = new User({
            username: 'nodemongobackend',
            email: 'info@nodemongobackend.com',
            phone_number: '08169121716',
            password: bcrypt.hashSync(_password),
            newpassword: '',
            country: 'Nigeria',
            ipAddress: req.ip,
            isVerified: false,
